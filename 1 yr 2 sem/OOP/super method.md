The __super__ is a reserved keyword which invokes a a special method that calls the constructor of the the immediate parent(super) class, the methods of the parent class or the attribute of the parent class.
...
__NB:__ The super keyword cannot be used to access an private methods and attribute.