The ip packet consists of the following:
...
6. IP Flags - 3 bits, can have flags such as do not fragment packet flag which prevents the packet from being sent if it it fragmented.
