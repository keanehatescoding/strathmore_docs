...
<<<<<<<< HEAD:2.1/Data and Voice Communication/Pulse Code Modulation.md
Therefore, sample and the hold circuit sample the signal at the rate $f_s$ where $f_s=\frac{1}{T_s}$. In order to avoid [[2.1/Data and Voice Communication/Glossary|aliasing]] the sampling frequency is selected to be equal to or above the [[Nyquist-Shanon Sampling Theoerem||Nyquist rate]] i.e
========
...
>>>>>>>> bf06da019ae9d6e4fda02774f41834f2e73c7b4d:2 yr 1 sem/Data and Voice Communication/Pulse Code Modulation.md
$$f_{s} \geq 2f_{m}$$
