...
1. <abbr title= "transmission control protocol">TCP</abbr>
2. <abbr title="user datagram protocol">UDP</abbr>
## 1.TCP 
<abbr title="transmission control protocol">TCP</abbr> has a mandatory three way handshake before any communication takes place which goes as follows:
...
<abbr title="transmission control protocol">TCP</abbr> also has congestion control to avoid overloading the network.
