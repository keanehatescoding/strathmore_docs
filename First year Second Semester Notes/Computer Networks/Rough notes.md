...
An ipv4 address is s 32 bit address.
An ipv6 address this is a 128 bit addresss.
...
## IPv6
It does not use subnetting instead it uses cidr notation to give us the prefix length of the ipv6 address i.e. number of bits making up the network portion of the ipv6 address.
